...
function EmailVerification() {
  const { verifySignUpOtp, isOtpVerifying, error } = useAuthStore();
  ...
  const submitOtp = async (verificationCode) => {
    try {
      await verifySignUpOtp(verificationCode);
  ...
  return (
    <div className="w-full flex items-center justify-center p-4 bg-slate-900">
      <div className="relative w-full mt-35 max-w-5xl md:h-[700px] h-[600px] md:mt-10">
              ...
              <div className="w-full max-w-md">
                ...
                >
                  ...
                  <button
                    className="auth-btn"
                    type="submit"
                    disabled={isOtpVerifying || otp.some((digit) => !digit)}
                  >
